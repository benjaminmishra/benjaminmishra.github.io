...
export default function Nav(): JSX.Element {
  return (
    <div className="px-2 sm:px-6 lg:px-8 flex-grow">
      <nav
        className="relative flex items-center justify-center h-10 font-FigTree"
        aria-label="Global"
      >
        <div className="flex md:items-center md:space-x-8 text-sm font-medium">
          ...
          <Link to="/projects" className="text-text-light dark:text-text-dark hover:text-primary flex items-center group">
            <svg
              className="w-5 h-5 md:mr-1"
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
              {/* Icon: code branch to represent projects */}
              <path
                fillRule="evenodd"
                d="M7.5 3A1.5 1.5 0 108 6a1.5 1.5 0 00-.5-2.914V7.9A2.5 2.5 0 017.9 10H12a3 3 0 013 3v.586a1.5 1.5 0 101 0V13a5 5 0 00-5-5H7.9A2.5 2.5 0 015 5.9V3.086A1.5 1.5 0 107.5 3zM14.5 15a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"
                clipRule="evenodd"
              />
            </svg>
